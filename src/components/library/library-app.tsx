            ...
            <>
              ...
              {sourceId === "adults" && browsing && (
                <>
                  ...
                  <TitleRail title="From official adult APIs" reason="Eporner, RedTube, and Chaturbate public APIs with source and fetish tags — one source failing still leaves the others." videos={filteredEporner} variant="rail" />
