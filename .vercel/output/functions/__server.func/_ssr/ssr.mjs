...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C_UhAHZV.mjs");
...
var manifest = {
	"0e94cec61957c6cccbe0dc56ae15e7a5544920a3a6da937df6a89d530e96fb39": {
		...
		importer: () => import("./functions-D-rOj23K.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B-a-giza.mjs").then((n) => n.t),
