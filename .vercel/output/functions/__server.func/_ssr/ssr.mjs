...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bzz43wQo.mjs");
...
var manifest = {
	"0e94cec61957c6cccbe0dc56ae15e7a5544920a3a6da937df6a89d530e96fb39": {
		...
		importer: () => import("./functions-Btbu5p34.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CvO0sHB2.mjs").then((n) => n.t),
