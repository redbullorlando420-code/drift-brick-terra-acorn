...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CF1Trds_.js
var router_CF1Trds__exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var $$splitComponentImporter = () => import("./routes-CsYlFxoy.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_CF1Trds__exports as t };
